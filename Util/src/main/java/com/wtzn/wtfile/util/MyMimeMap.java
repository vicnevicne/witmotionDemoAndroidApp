...
public class MyMimeMap {
    ...
    /**
     *  Commonly used "file extension-MIME type" matching table.
     *  Note that this table is not complete, nor is it unique, just like some people like to open TXT with a browser, you can customize it according to your own preferences.
     */
